...
\item[$\Rightarrow$] \emph{Transport layer}: a VM kernel driver.
...
\item[$\Rightarrow$] Polish the peer discovery framework to adaptively use V4VSockets over generic TCP sockets. 
